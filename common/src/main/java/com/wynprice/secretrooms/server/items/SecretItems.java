...
public class SecretItems {
    ...
    public static final RegistryHolder<Item> REGISTRY = SecretRoomsServices.PLATFORM.createItemRegistryHolder();
    ...
    public static final Supplier<Item> TORCH_LEVER = REGISTRY.register("torch_lever", () -> new StandingAndWallBlockItem(Objects.requireNonNull(SecretBlocks.TORCH_LEVER.get()), Objects.requireNonNull(SecretBlocks.WALL_TORCH_LEVER.get()), prop(), Direction.DOWN));
