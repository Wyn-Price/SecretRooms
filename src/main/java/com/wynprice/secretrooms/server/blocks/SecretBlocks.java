...
public class SecretBlocks {
    ...
    public static final Supplier<Block> SECRET_DUMMY_BLOCK = REGISTRY.register("secret_dummy_block", () -> new SecretBaseBlock(Block.Properties.of(Materials.SRM_MATERIAL).noOcclusion().noDrops()));
