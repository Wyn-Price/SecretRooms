...
public class SecretRecipeProvider extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ShapedRecipeBuilder.shapedRecipe(TORCH_LEVER).key('T', Items.TORCH).key('L', Items.LEVER).patternLine("T").patternLine("L").setGroup("torch_lever").addCriterion("has_torch_lever", this.hasItems(Items.TORCH, Items.LEVER)).build(consumer);
